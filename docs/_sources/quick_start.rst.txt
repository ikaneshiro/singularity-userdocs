...
<\{admindocbaseurl\}/installation.html>`__.
...
You can use the `pull <\{docbaseurl\}/cli/singularity_pull.html>`_
and `build <\{docbaseurl\}/cli/singularity_build.html>`_
...
The `shell <\{docbaseurl\}/cli/singularity_shell.html>`_
...
The `exec <\{docbaseurl\}/cli/singularity_exec.html>`_
...
runs it. The runscript can be triggered with the `run <\{docbaseurl\}/cli/singularity_run.html>`_
...
.. code-block:: none
    ...
    learn more about Singularity, I thought these items might be of interest:
        ...
        \{admindocbaseurl\}/admin_quickstart.html

        - Installation:
        \{admindocbaseurl\}/installation.html
