...
`pull <\{docbaseurl\}/cli/singularity_pull.html>`_,
`push <\{docbaseurl\}/cli/singularity_push.html>`_,
`build --remote <\{docbaseurl\}/cli/singularity_build.html#options>`_,
`key <\{docbaseurl\}/cli/singularity_key.html>`_,
`search <\{docbaseurl\}/cli/singularity_search.html>`_,
`verify <\{docbaseurl\}/cli/singularity_verify.html>`_,
`exec <\{docbaseurl\}/cli/singularity_exec.html>`_,
`shell <\{docbaseurl\}/cli/singularity_shell.html>`_,
`run <\{docbaseurl\}/cli/singularity_run.html>`_,
`instance <\{docbaseurl\}/cli/singularity_instance.html>`_
...
`pull <\{docbaseurl\}/cli/singularity_pull.html>`_,
`push <\{docbaseurl\}/cli/singularity_push.html>`_,
`build <\{docbaseurl\}/cli/singularity_build.html>`_,
`exec <\{docbaseurl\}/cli/singularity_exec.html>`_,
`shell <\{docbaseurl\}/cli/singularity_shell.html>`_,
`run <\{docbaseurl\}/cli/singularity_run.html>`_,
`instance <\{docbaseurl\}/cli/singularity_instance.html>`_
